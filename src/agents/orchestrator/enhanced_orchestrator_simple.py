"""
Simplified Enhanced Extraction Orchestrator
    ...
    async def extract_from_file(self, 
        ...
        async def _extract_from_segment(self, 
            ...
            try:
                ...
                # Extract treatments
                treatments_task = {"patient_segment": patient_segment}
                treatments_result = await self.agents['treatments'].execute(treatments_task)
